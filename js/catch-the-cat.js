	...
	var k = function(t) {
			...
			return r(e, t), Object.defineProperty(e.prototype, "blocks", {
				...
				set: function(t) {
					...
					case i.WIN:
						this.setStatusText(f.
					default ("在这个网页后面加上/·index.htm 可以..."));
						break;
					default:
						return
					}
			...
			default ("在这个网页后面加上/·index.htm 可以...")), this.state = i.WIN, !1) : (this.setStatusText(f.
			default ("您点击了 ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.
			default ("在这个网页后面加上/·index.htm 可以...")), this.state = i.WIN), !0)) : (this.setStatusText(f.
